...
timeForGamesApp.factory('logger', [function () {
...
timeForGamesApp.factory('historyService', ['$http', 'config', function ($http, config) {
...
timeForGamesApp.factory('settingsService', ['$http', 'config', function ($http, config) {
...
timeForGamesApp.factory('plannerService', ['$http', 'config', 'planningBuilderService', function($http, config, planningBuilderService) {
